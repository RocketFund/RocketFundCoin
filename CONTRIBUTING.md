Contributing to ROCKETFUND Core
============================

The ROCKETFUND Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/RocketFund/RocketFundCoin/blob/master/doc/translation_process.md)
...
The following applies to code changes to the ROCKETFUND Core project, and is not to be
confused with overall ROCKETFUNDCOIN Network Protocol consensus changes.

Whether a pull request is merged into ROCKETFUND Core rests with the project merge
...
Patches that change ROCKETFUNDCOIN consensus rules are considerably more involved than
...
Where a patchset proposes to change the ROCKETFUNDCOIN consensus, it must have been
...
The project leader is the release manager for each ROCKETFUND Core release.
