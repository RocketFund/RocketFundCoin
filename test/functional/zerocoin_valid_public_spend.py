...
from fake_stake.base_test import ROCKETFUNDCOIN_FakeStakeTest

class zRKTValidCoinSpendTest(ROCKETFUNDCOIN_FakeStakeTest):
    ...
    def run_test(self):
        ...
        # 2) Mint zerocoins
        self.log.info("Minting %d-denom zRKTs..." % DENOM_TO_USE)
