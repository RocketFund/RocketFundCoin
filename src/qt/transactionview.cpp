 ...
 */
    ...
    typeWidget->addItem(tr("Minted"), TransactionFilterProxy::TYPE(TransactionRecord::StakeMint) | TransactionFilterProxy::TYPE(TransactionRecord::StakeZRKT));
    typeWidget->addItem(tr("Masternode Reward"), TransactionFilterProxy::TYPE(TransactionRecord::MNReward));
//    typeWidget->addItem(tr("Received RKT from zRKT"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
...
//    typeWidget->addItem(tr("Zerocoin Spend, Change in zRKT"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zRkt));
