                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzRKTPathCustom = GetArg("-zrktbackuppath", "");
    ...
    if(!strzRKTPathCustom.empty()) {
        ui->wallet_customzrktbackuppath->setText(QString::fromStdString(strzRKTPathCustom));
        ui->wallet_customzrktbackuppath_label->setVisible(true);
        ui->wallet_customzrktbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzRKTPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the ROCKETFUNDCOIN RPC console.") + "<br>" +
