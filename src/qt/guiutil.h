...
/** Utility functions used by the ROCKETFUNDCOIN Qt UI.
 */
namespace GUIUtil
{
...
// Render ROCKETFUNDCOIN addresses in monospace font
...
// Parse "rocketfundcoin:" URI into recipient object, return true on successful parsing
