...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("ROCKETFUND Core"),
     ...
     * override -datadir in the rocketfundcoin.conf file in the default data directory
     * (to be consistent with rocketfundcoind behavior)
     */
    if (dataDir != getDefaultDataDirectory())
