...
public:
    ...
    void setZRktControlLabels(int64_t nAmount, int nQuantity);
...
// MINT disabled    void on_pushButtonMintzRKT_clicked();
    void on_pushButtonMintReset_clicked();
    void on_pushButtonSpentReset_clicked();
    void on_pushButtonSpendzRKT_clicked();
    void on_pushButtonZRktControl_clicked();
