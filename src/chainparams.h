 ...
 * ROCKETFUNDCOIN system. There are three: the main network on which people trade goods
...
public:
    ...
    int RocketFundCoinBadBlockTime() const { return nRocketFundCoinBadBlockTime; }
    int RocketFundCoinBadBlocknBits() const { return nRocketFundCoinBadBlocknBits; }
...
protected:
    ...
    int nLastPOWBlock;
    int64_t nRocketFundCoinBadBlockTime;
    unsigned int nRocketFundCoinBadBlocknBits;
