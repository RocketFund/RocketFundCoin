...
#ifndef ROCKETFUNDCOIN_ZRKTWALLET_H
#define ROCKETFUNDCOIN_ZRKTWALLET_H
...
public:
    CzRKTWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZRKT(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZRKT(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
...
#endif //ROCKETFUNDCOIN_ZRKTWALLET_H
