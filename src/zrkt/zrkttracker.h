...
#ifndef ROCKETFUNDCOIN_ZRKTTRACKER_H
#define ROCKETFUNDCOIN_ZRKTTRACKER_H
...
public:
    CzRKTTracker(std::string strWalletFile);
    ~CzRKTTracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CzRKTWallet* zRKTWallet = NULL);
...
#endif //ROCKETFUNDCOIN_ZRKTTRACKER_H
