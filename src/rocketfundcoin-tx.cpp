...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("RocketFundCoin Core rocketfundcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  rocketfundcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded rocketfundcoin transaction") + "\n" +
                               "  rocketfundcoin-tx [options] -create [commands]   " + _("Create hex-encoded rocketfundcoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded rocketfundcoin transaction
