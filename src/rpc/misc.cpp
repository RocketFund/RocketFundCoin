...
UniValue getinfo(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 0)
        throw std::runtime_error(
            ...
            "  \"balance\": xxxxxxx,         (numeric) the total rocketfundcoin balance of the wallet (excluding zerocoins)\n"
...
//            "  \"zRKTsupply\" :\n"
//            "  {\n"
//            "     \"1\" : n,            (numeric) supply of 1 zRKT denomination\n"
//            "     \"5\" : n,            (numeric) supply of 5 zRKT denomination\n"
//            "     \"10\" : n,           (numeric) supply of 10 zRKT denomination\n"
//            "     \"50\" : n,           (numeric) supply of 50 zRKT denomination\n"
//            "     \"100\" : n,          (numeric) supply of 100 zRKT denomination\n"
//            "     \"500\" : n,          (numeric) supply of 500 zRKT denomination\n"
//            "     \"1000\" : n,         (numeric) supply of 1000 zRKT denomination\n"
//            "     \"5000\" : n,         (numeric) supply of 5000 zRKT denomination\n"
//            "     \"total\" : n,        (numeric) The total supply of all zRKT denominations\n"
//            "  }\n"
            "  \"keypoololdest\": xxxxxx,    (numeric) the timestamp (seconds since GMT epoch) of the oldest pre-generated key in the key pool\n"
            "  \"keypoolsize\": xxxx,        (numeric) how many new keys are pre-generated\n"
            "  \"unlocked_until\": ttt,      (numeric) the timestamp in seconds since epoch (midnight Jan 1 1970 GMT) that the wallet is unlocked for transfers, or 0 if the wallet is locked\n"
            "  \"paytxfee\": x.xxxx,         (numeric) the transaction fee set in rocketfundcoin/kb\n"
            "  \"relayfee\": x.xxxx,         (numeric) minimum relay fee for non-free transactions in rocketfundcoin/kb\n"
...
//        obj.push_back(Pair("zerocoinbalance", ValueFromAmount(pwalletMain->GetZerocoinBalance(true))));
    ...
    UniValue zrktObj(UniValue::VOBJ);
    for (auto denom : libzerocoin::zerocoinDenomList) {
        zrktObj.push_back(Pair(std::to_string(denom), ValueFromAmount(chainActive.Tip()->mapZerocoinSupply.at(denom) * (denom*COIN))));
    }
    zrktObj.push_back(Pair("total", ValueFromAmount(chainActive.Tip()->GetZerocoinSupply())));
//    obj.push_back(Pair("zRKTsupply", zrktObj));
...
UniValue validateaddress(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 1)
        throw std::runtime_error(
            "validateaddress \"rocketfundcoinaddress\"\n"
            "\nReturn information about the given rocketfundcoin address.\n"

            "\nArguments:\n"
            "1. \"rocketfundcoinaddress\"     (string, required) The rocketfundcoin address to validate\n"

            "\nResult:\n"
            "{\n"
            "  \"isvalid\" : true|false,         (boolean) If the address is valid or not. If not, this is the only property returned.\n"
            "  \"address\" : \"rocketfundcoinaddress\", (string) The rocketfundcoin address validated\n"
...
#ifdef ENABLE_WALLET
        // Case 1: ROCKETFUNDCOIN address and we have full public key:
...
UniValue createmultisig(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() < 2 || params.size() > 2)
        throw std::runtime_error(
            ...
            "2. \"keys\"       (string, required) A json array of keys which are rocketfundcoin addresses or hex-encoded public keys\n"
            "     [\n"
            "       \"key\"    (string) rocketfundcoin address or hex-encoded public key\n"
            "       ,...\n"
            "     ]\n"
...
UniValue verifymessage(const UniValue& params, bool fHelp)
{
    if (fHelp || params.size() != 3)
        throw std::runtime_error(
            "verifymessage \"rocketfundcoinaddress\" \"signature\" \"message\"\n"
            "\nVerify a signed message\n"

            "\nArguments:\n"
            "1. \"rocketfundcoinaddress\"  (string, required) The rocketfundcoin address to use for the signature.\n"
