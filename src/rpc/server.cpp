...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw std::runtime_error(
            "stop\n"
            "\nStop ROCKETFUNDCOIN server.");
    // Event loop will exit after current HTTP requests have been handled, so
    // this reply will get back to the client.
    StartShutdown();
    return "ROCKETFUNDCOIN server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* ROCKETFUNDCOIN features */
        {"rocketfundcoin", "listmasternodes", &listmasternodes, true, true, false},
        {"rocketfundcoin", "getmasternodecount", &getmasternodecount, true, true, false},
        {"rocketfundcoin", "masternodeconnect", &masternodeconnect, true, true, false},
        {"rocketfundcoin", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"rocketfundcoin", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"rocketfundcoin", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"rocketfundcoin", "masternodecurrent", &masternodecurrent, true, true, false},
        {"rocketfundcoin", "masternodedebug", &masternodedebug, true, true, false},
        {"rocketfundcoin", "startmasternode", &startmasternode, true, true, false},
        {"rocketfundcoin", "createmasternodekey", &createmasternodekey, true, true, false},
        {"rocketfundcoin", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"rocketfundcoin", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"rocketfundcoin", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"rocketfundcoin", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"rocketfundcoin", "getmasternodescores", &getmasternodescores, true, true, false},
        {"rocketfundcoin", "preparebudget", &preparebudget, true, true, false},
        {"rocketfundcoin", "submitbudget", &submitbudget, true, true, false},
        {"rocketfundcoin", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"rocketfundcoin", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"rocketfundcoin", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"rocketfundcoin", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"rocketfundcoin", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"rocketfundcoin", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"rocketfundcoin", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"rocketfundcoin", "checkbudgets", &checkbudgets, true, true, false},
        {"rocketfundcoin", "mnsync", &mnsync, true, true, false},
        {"rocketfundcoin", "spork", &spork, true, true, false},
        {"rocketfundcoin", "getpoolinfo", &getpoolinfo, true, true, false},
...
//        {"zerocoin", "getzrktseed", &getzrktseed, false, false, true},
//        {"zerocoin", "setzrktseed", &setzrktseed, false, false, true},
//        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
//        {"zerocoin", "searchdzrkt", &searchdzrkt, false, false, true},
//        {"zerocoin", "dzrktstate", &dzrktstate, false, false, true},
...
{
    return "> rocketfundcoin-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(std::string methodname, std::string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:36144/\n";
}
