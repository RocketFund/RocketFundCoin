...
// Copyright (c) 2016-2018 The ROCKETFUNDCOIN developers
...
// ROCKETFUNDCOIN: on startup load spork values from previous session if they exist in the sporkDB
...
void ProcessSpork(CNode* pfrom, std::string& strCommand, CDataStream& vRecv)
{
    ...
    if (strCommand == "spork") {
        ...
        // ROCKETFUNDCOIN: add to spork database.
